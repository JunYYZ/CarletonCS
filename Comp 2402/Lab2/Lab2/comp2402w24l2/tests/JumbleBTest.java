...
// javac -cp "./lib/*:." comp2402w24l2/tests/JumbleBTest.java
// java -cp "./lib/*:." comp2402w24l2/tests/JumbleBTest


import org.junit.jupiter.api.Test;
import static org.junit.jupiter.api.Assertions.*;

import comp2402w24l2.JumbleB;
import comp2402w24l2.Jumble;
import input.InputGenerator;
import input.AlternatingCharGenerator;


public class JumbleBTest {
    ...
    public static void main(String[] args) {
        ...
        switch (n) {
            ...
            case 2:
                ...
                allSame(0); // empty strand -- should be "".
                break;
            case 3:
                int size=10000;
