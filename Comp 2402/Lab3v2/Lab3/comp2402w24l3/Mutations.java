...
public class Mutations {
    ...
    public static void main(String[] args ) {
        ...
        // gen = new FileCharGenerator( "samples/mutations-sample.txt" );
        // System.out.println( mutations(gen, 3) ); // Expect 3


        // If you want to test via the command-line, i.e. if you want to input a stream of
        // characters of your own devising and then run mutations once you hit 'Enter', then
        // uncomment the next three lines.
        // gen = new FileCharGenerator();
        // System.out.println( "Enter a sequence of characters, then hit Enter to run mutations(gen, 3):" );
        ...
        gen = new AlternatingCharGenerator(options, 5, true); // Generates UGCAU -- uses true to store what was generated
