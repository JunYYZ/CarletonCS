...
// javac -cp "./lib/*:." comp2402w24l3/tests/GenesTest.java
// java -cp "./lib/*:." comp2402w24l3/tests/GenesTest
//
...
public class GenesTest {
    ...
    public static void allSame(int n, int k) {
        ...
        for( int i=0; i < bases.length; i++ ) {
            ...
            if( k <= n )
              assertEquals(1, Genes.genes(gen, k), "All same character k <= n should return 1 " + gen);
            else 
    ...
    public static void alternatingChar(int n) {
        ...
        assertEquals(4, Genes.genes(gen, 4),
                "Alternating characters A, U, C, G, with k=4 should return 4 " + gen);
        gen = new AlternatingCharGenerator(bases, n, (n < 100));
        assertEquals(4, Genes.genes(gen, 8),
                "Alternating characters A, U, C, G, with k=8 should return 4 " + gen);
        gen = new AlternatingCharGenerator(bases, n, (n < 100));
    ...
    public static void alternatingChar(int n, int k) {
        ...
        assertEquals(4, Genes.genes(gen, k),
                "Alternating characters A, U, C, G, with k=" + k + " should return 4 " + gen);
    }
    ...
    public static void main(String[] args) {
        ...
        switch (n) {
            ...
            case 3:
                int size=5000;
                System.out.println( "Testing genes() O(n^2 k) time performance n~" + size + ", variety of k...");
            ...
            case 4:
                size=100000;
                System.out.println( "Testing genes() O(nk^2) time performance n~" + size + ", k < 2,000...");
                System.out.println( "\tYou pass this test if it executes within 2 seconds.");
                System.out.println( "\tIf it's taking forever, try CTRL-C or CTRL-Z to stop it.");
                allSame(size, 1000);
            ...
            case 5:
                size=13000;
                System.out.println( "Testing genes() O(nk^2) time performance n~" + size + ", variety of k...");
                System.out.println( "\tYou pass this test if it executes within 2 seconds.");
                System.out.println( "\tIf it's taking forever, try CTRL-C or CTRL-Z to stop it.");
            ...
            case 7:
                ...
                size=1000000;
                System.out.println( "Testing genes() O(kd) space performance n~" + size + ", k~10...");
                allSame(size, 20);
                alternatingChar(size, 20);
                break;
            default:
