...
// javac -cp "./lib/*:." comp2402w24l3/tests/GenesOrderTest.java
// java -cp "./lib/*:." comp2402w24l3/tests/GenesOrderTest
//
...
import comp2402w24l3.GenesOrder;
...
public class GenesOrderTest {
    ...
    public static void allSame(int n, int k) {
        ...
        for( int i=0; i < bases.length; i++ ) {
            ...
            if( k <= n ) {
                ...
                assertEquals(Arrays.asList(expected), GenesOrder.genesOrder(gen, k), "All same character k <= n should return 1 " + gen);
            } else {
                String[] expected = {};
                assertEquals(Arrays.asList(expected), GenesOrder.genesOrder(gen, k), "All same character k > n should return 0 " + gen);
            }
        }
    }
    ...
    public static void alternatingChar(int n, int k) {
        ...
        String[] exp = {s.substring(0,k), s.substring(1,k+1), s.substring(2,k+2), s.substring(3)};
