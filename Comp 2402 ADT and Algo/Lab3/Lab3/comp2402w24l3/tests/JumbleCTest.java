...
// javac -cp "./lib/*:." comp2402w24l3/tests/JumbleCTest.java
// java -cp "./lib/*:." comp2402w24l3/tests/JumbleCTest
//
...
import comp2402w24l3.JumbleC;
import comp2402w24l3.Jumble;
import input.InputGenerator;
import input.AlternatingCharGenerator;
import input.RandomCharGenerator;


public class JumbleCTest {
    ...
    public static void randomChar(int n) {
        System.out.println("\tTesting jumbleC() random input n~" + n );
    ...
    public static void main(String[] args) {
        ...
        switch (n) {
            ...
            case 4:
                size=600000;
                System.out.println( "Testing jumble() O(n log n) time, only rewinds, adding near front size=" + size + "...");
                System.out.println( "\tYou pass this test if it executes within 2 seconds.");
                System.out.println( "\tIf it's taking forever, try CTRL-C or CTRL-Z to stop it.");
                alternatingChar(size);
                break;
            case 5:
                size=600000;
                System.out.println( "Testing jumble() O(n log n) time no rew/ff size=" + size + "...");
                System.out.println( "\tYou pass this test if it executes within 2 seconds.");
                System.out.println( "\tIf it's taking forever, try CTRL-C or CTRL-Z to stop it.");
                allSame(size);
                //alternatingChar(size);
                break;
            case 6:
                System.out.println( "If you didn't already, run this test (6) with -Xmx128m");
                size=1000000;
            ...
            case 7: // rewinds and ff
                ...
                rewFFChar();
                break;
            case 8: // random, performance test only
                size=1000000;
                System.out.println( "Testing jumble() random input, O(n log n) performance test only, size=" + size);
                System.out.println( "\tYou pass this test if it executes within 2 seconds.");
                System.out.println( "\tIf it's taking forever, try CTRL-C or CTRL-Z to stop it.");
                randomChar(size);
                break;
