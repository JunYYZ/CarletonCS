...
bool Repo::removeFile(const int& index)
{
...
void Repo::printContents(const int& index) const
{
    File *file = fileList->get(index);
    if (file != nullptr)
    {
        file->printContents(); // print file metadata and contents
    }
    else
    {
