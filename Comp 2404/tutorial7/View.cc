...
// void View::drawOnMap(Customer& c){
//     Location l = c.getLocation();
//     map[l.y*2][l.x*4+1]=c.getName()[0];
// }

// void View::drawOnMap(Driver& d){
//     Location l = d.getLocation();
//     map[l.y*2-1][l.x*4-1]=d.getName()[0];
// }

// void View::drawOnMap(Block& b){
//     Location l = b.getLocation();
//     map[l.y*2][l.x*4]='|';
//     map[l.y*2-1][l.x*4+1]='_';
//     map[l.y*2][l.x*4+1]='_';
//     map[l.y*2][l.x*4+2]='|';
// }
